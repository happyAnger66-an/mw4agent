...
const en: Record<string, string> = {
  ...
  settingsSkillsPerAgentHint:
    "Stored in ~/.mw4agent/agents/<id>/agent.json as skills. Empty list means this agent sees no skills. Clear override removes the field so only the global filter applies.",
...
const zhCN: Record<string, string> = {
  ...
  settingsSkillsPerAgentHint:
    "保存在 ~/.mw4agent/agents/<id>/agent.json 的 skills。空数组表示该智能体不使用任何技能；清除覆盖会删除该字段，仅应用全局 filter。",
